...
void initializeTable(SymbolTable *S) {
    ...
    index++;
    S->keys[index] = "R10";
    S->addresses[index] = 10;
    index++;
    S->keys[index] = "R11";
    S->addresses[index] = 11;
    index++;
    S->keys[index] = "R12";
    S->addresses[index] = 12;
    index++;
    S->keys[index] = "R13";
    S->addresses[index] = 13;
    index++;
    S->keys[index] = "R14";
    S->addresses[index] = 14;
    index++;
    S->keys[index] = "R15";
    S->addresses[index] = 15;
    index++;
    S->keys[index] = "SCREEN";
    S->addresses[index] = 16384;
    index++;
    S->keys[index] = "KBD";
    S->addresses[index] = 24576;
    index++;
    S->index = index;
    S->varIndex = 16;
}
...
void addEntry(SymbolTable *S, char *symbol, int address) {
    S->keys[S->index] = symbol;
    S->addresses[S->index] = address;
    S->index++;
}
